        ...
        <Modal showModal={showDeleteModal} setShowModal={setShowDeleteModal}>
          ...
          >
            ...
            <div className="flex justify-between items-center mt-10 w-full">
              <button
                type="button"
                className="w-full px-5 py-5 text-sm text-gray-400 hover:text-black border-t border-grayBorderColor rounded-bl focus:outline-none focus:ring-0 transition-all ease-in-out duration-150"
        ...
        <footer className="h-20 z-20 fixed bottom-0 inset-x-0 border-solid border-t border-gray-500 bg-white">
          <div className="max-w-screen-xl mx-auto px-10 sm:px-20 h-full flex justify-end items-center">
            <button
              ...
              className={`${
                saving
                  ? 'cursor-not-allowed bg-gray-300 border-grayBorderColor'
