  ...
  return (
    <>
      <div>
        ...
        <div className="absolute left-0 right-0 h-16 border-b bg-white border-gray-200 dark:bg-black dark:border-gray-500">
        ...
        {rootPage && (
          <div className="absolute left-0 right-0 top-16 flex justify-center items-center font-cal space-x-16 border-b bg-white border-gray-200 dark:bg-black">
            <Link
              href="/"
