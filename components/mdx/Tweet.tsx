...
export default function Tweet({ id, metadata, className }: TweetProps) {
  ...
  return (
    <div
      className={`${className} tweet rounded-lg border border-grayBorderColor bg-white px-8 pt-6 pb-2 my-4 w-full`}
    >
      ...
      <div className="border-t border-grayBorderColor pt-1 flex space-x-2 md:space-x-6 text-base text-gray-700 mt-2">
        <a
